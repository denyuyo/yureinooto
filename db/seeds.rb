...
Post.create!(user_id, title: "タージ・マハル",
...
Post.create!(user_id, title: "厳島神社",
content: "水位が浅いときはもう少し近くで鳥居を拝めそう", image: "itukushima-jinjya.jpg")
Post.create!(user_id, title: "済州火山島と溶岩洞窟群",
...
Post.create!(user_id, title: "ヴァルカモニカの岩絵群",
...
Post.create!(user_id, title: "ケルン大聖堂",
...
Post.create!(user_id, title: "モスクワのクレムリンと赤の広場",
...
Post.create!(user_id, title: "青海可可西里（フフシル）",
...
Post.create!(user_id, title: "白神山地",
